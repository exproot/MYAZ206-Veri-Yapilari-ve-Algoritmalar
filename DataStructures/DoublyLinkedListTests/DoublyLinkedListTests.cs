...
public class DoublyLinkedListTests 
{
    ...
    public void DbLinkedList_AddFirst_Test()
    {
        ...
        // Assert
        Assert.Equal(4, linkedList.Head.Val);
        Assert.Equal(3, linkedList.Head.Next.Val);
        Assert.Equal(2, linkedList.Tail.Prev.Val);
        Assert.Equal(1, linkedList.Tail.Val);
    }
    ...
    public void DbLinkedList_AddLast_Test()
    {
        ...
        // Assert
        Assert.Equal(4, linkedList.Tail.Val);
        Assert.Equal(3, linkedList.Tail.Prev.Val);
        Assert.Equal(2, linkedList.Head.Next.Val);
        Assert.Equal(1, linkedList.Head.Val);
    }
